...
(function () {
  ...
  const I18N = {
    zh: {
      ...
      cWorking: 'Claude 工作中…', cWaiting: 'Claude 等你确认…', cDone: '✓ 完成！',
      sleepy: '有点困…', zzz: 'Zzz…',
      ...
      optsHint: '每行一个选项。行首加前缀设规则：<br>「+」爱吃：连续 5 次没摇中就 +20% 概率；<br>「-」难吃：每摇中一次 -20% 概率，之后慢慢回升；<br>不加前缀＝普通等概率。',
    ...
    en: {
      ...
      cWorking: 'Claude working…', cWaiting: 'Claude needs you…', cDone: '✓ Done!',
      ...
      optsHint: 'One option per line. Prefix sets a rule:<br>“+” favorite: +20% odds after 5 misses in a row;<br>“-” dislike: −20% odds each time it’s drawn, then recovers;<br>no prefix = normal, equal odds.',
